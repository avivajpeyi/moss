...
os.chdir(
    "C:/Users/jliu812/OneDrive - The University of Auckland/Desktop/PhD学习材料/supplementary_materials/code"
)
from model import modified_ll_128_spec_vi

f = h5py.File(
    "C://Users//jliu812//OneDrive - The University of Auckland//Desktop//gravitational wave data analysis//HDF5Files_NZ//X_ETnoise_GP.hdf5",
    "r",
)
X_ETnoise_GP = f["E1:STRAIN"]

f = h5py.File(
    "C://Users//jliu812//OneDrive - The University of Auckland//Desktop//gravitational wave data analysis//HDF5Files_NZ//Y_ETnoise_GP.hdf5",
    "r",
)
Y_ETnoise_GP = f["E2:STRAIN"]

f = h5py.File(
    "C://Users//jliu812//OneDrive - The University of Auckland//Desktop//gravitational wave data analysis//HDF5Files_NZ//Z_ETnoise_GP.hdf5",
    "r",
)
...
def real_to_complex(matrix):
    ...
    complex_matrix[np.triu_indices(n, 1)] = (
        matrix[np.triu_indices(n, 1)] - 1j * matrix[np.tril_indices(n, -1)]
    )
    complex_matrix[np.tril_indices(n, -1)] = (
        matrix[np.triu_indices(n, 1)] + 1j * matrix[np.tril_indices(n, -1)]
    )
...
plt.title(
    "Squared coherence for ET noise with correlated GP", pad=20, fontsize=20
)
